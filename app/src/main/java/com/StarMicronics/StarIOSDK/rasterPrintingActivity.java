...
public class rasterPrintingActivity extends Activity implements OnItemSelectedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (PrinterTypeActivity.getPortSettings().toUpperCase(Locale.US).equals("MINI") || PrinterTypeActivity.getPortSettings().toUpperCase(Locale.US).equals("MINI;L")) {
	...
	public void PrintText(View view) {
		...
		if (portSettings.toUpperCase(Locale.US).equals("MINI") || portSettings.toUpperCase(Locale.US).equals("MINI;L")) {
			paperWidth = 408;
		...
		if (((portSettings.toUpperCase(Locale.US).equals("MINI")) && (pageModeEnable == true)) || ((portSettings.toUpperCase(Locale.US).equals("MINI;L")) && (true == pageModeEnable))) {
			if (height > 2378) {
				height = 2378;
			}
		}

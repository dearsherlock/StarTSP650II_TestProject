...
public class kanjiTextFormatingDotPrinterActivity extends Activity {
	@Override
	...
	public void PrintText(View view) {
		...
		PrinterFunctions.PrintTextbyDotPrinter(this, portName, portSettings, false, underline, twoColor, emphasized, upperline, upsideDown, false, widthExpansion, leftMargin, alignment, textToPrint, shiftJIS);
	}

...
public class textFormatingDotPrinterActivity extends Activity {
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.textformating);
	...
	public void PrintText(View view) {
		...
		CheckBox checkbox_slashedZero = (CheckBox) findViewById(R.id.checkBox_ShashedZero);
		boolean slashedZero = checkbox_slashedZero.isChecked();
		...
		boolean heightExpansion = checkbox_Height.isChecked();
		...
		PrinterFunctions.PrintTextbyDotPrinter(this, portName, portSettings, slashedZero, underline, twoColor, emphasized, upperline, upsideDown, heightExpansion, widthExpansion, leftMargin, alignment, textToPrint, "");
	}

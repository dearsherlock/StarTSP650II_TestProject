...
public class traditionalchineseTextFormatingActivity extends Activity {
	@Override
	...
	public void PrintText(View view) {
		...
		PrinterFunctions.PrintText(this, portName, portSettings, false, underline, invertColor, emphasized, upperline, upsideDown, heightExpansion, widthExpansion, leftMargin, alignment, textToPrint, "Big5");
	}

...
public class textFormatingActivity extends Activity {
	@Override
	...
	public void PrintText(View view) {
		...
		PrinterFunctions.PrintText(this, portName, portSettings, slashedZero, underline, invertColor, emphasized, upperline, upsideDown, heightExpansion, widthExpansion, leftMargin, alignment, textToPrint, "");
	}

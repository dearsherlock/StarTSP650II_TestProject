...
public class textFormatingMiniActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> ad = new ArrayAdapter<String>(this, R.layout.spinner, new String[] { " x1", " x2", " x3", " x4", " x5", " x6", " x7", " x8" });
		spinner_height.setAdapter(ad);
		ad.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
				
		Spinner spinner_width = (Spinner) findViewById(R.id.spinner_width);
		ad = new ArrayAdapter<String>(this, R.layout.spinner, new String[] { " x1", " x2", " x3", " x4", " x5", " x6", " x7", " x8" });

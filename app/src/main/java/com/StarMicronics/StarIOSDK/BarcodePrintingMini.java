...
public class BarcodePrintingMini extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ArrayAdapter<String> ad = new ArrayAdapter<String>(this, R.layout.spinner, new String[] { "0.125", "0.25", "0.375", "0.5", "0.625", "0.75", "0.875", "1.0" });
		spinner_Width.setAdapter(ad);
		ad.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

		Spinner spinner_Barcode = (Spinner) findViewById(R.id.spinner_barcodeType);
		ad = new ArrayAdapter<String>(this, R.layout.spinner, new String[] { "Code39", "ITF", "Code93", "Code128" });
	...
	public void Help(View view) {
		String helpString =
				"<UnderlineTitle>Set Barcode Height</UnderlineTitle><br/><br/>" +

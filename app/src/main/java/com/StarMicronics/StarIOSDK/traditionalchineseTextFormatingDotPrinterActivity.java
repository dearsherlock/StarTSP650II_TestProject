...
public class traditionalchineseTextFormatingDotPrinterActivity extends Activity {
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.traditionalchinesetextformating);
	...
	public void PrintText(View view) {
		...
		PrinterFunctions.PrintTextbyDotPrinter(this, portName, portSettings, false, underline, twoColor, emphasized, upperline, upsideDown, false, widthExpansion, leftMargin, alignment, textToPrint, "Big5");
	}
